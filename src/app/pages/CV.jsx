      ...
      <Container maxWidth="xl" sx={{ flex: 1, display: 'flex', flexDirection: 'column', py: 4 }}>
        ...
        <Box sx={{ textAlign: 'center', mb: 3 }}>
            <Stack direction="row" spacing={2} justifyContent="center" alignItems="center" sx={{ mb: 2 }}>
                ...
                <Typography variant="h2" sx={{ fontWeight: 800, background: 'linear-gradient(135deg, #667eea 0%, #d946ef 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                    My Resume
                </Typography>
            </Stack>
        ...
        <Grid container spacing={3} sx={{ flex: 1 }}>
            ...
            <Grid item xs={12} lg={4}>
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6} lg={12}>
                        <Paper sx={{ p: 2.5, background: 'linear-gradient(135deg, rgba(102, 126, 234, 0.05) 0%, rgba(217, 70, 239, 0.05) 100%)', border: '1px solid rgba(102, 126, 234, 0.2)', borderRadius: 3 }}>
